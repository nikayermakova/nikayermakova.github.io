...
We predict a positive and statistically significant correlation between food insecurity and obesity rates. Regarding the cluster analysis, we expect greater food insecurity and obesity vulnerability in more rural areas, as well as in areas with a higher population of people of color, lower education levels, and lower income. Furthermore, we predict that the moderation analysis will indicate that income levels, race, education, and geographic location will all play a statistically significant role in moderating the relationship between food insecurity and obesity.
